...
$(document).ready(function() {
    ...
    // 3. TOUCH-FRIENDLY CAROUSEL ON MOBILE
    if ($(window).width() <= 767) {
        $('.tm-carousel').slick({
            dots: true,
            arrows: false,
    ...
    var $backToTop = $('<a href="#home" class="back-to-top"><i class="fas fa-arrow-up"></i></a>');
    ...
    // 6. ENSURE PROPER VIEWPORT ON MOBILE
    ...
    // 7. ENHANCE TOUCH EXPERIENCE
    if ('ontouchstart' in window) {
        $('body').addClass('touch-device');
        $('.tm-carousel-item').css('cursor', 'pointer');
    }
    
    // 8. PREVENT ZOOM ON DOUBLE-TAP (Optional)
    var lastTouchEnd = 0;
